...
Kernel evolution uses a *separate* LLM from your own reasoning, on a schedule (after enough data, every few observations, frozen past a fraction of the budget). You do not need to trigger it. Force a round after a regime change:
